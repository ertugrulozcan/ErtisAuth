...
using ErtisAuth.Sdk.Middleware;
...
public static class ErtisAuthExtensions
{
	...
	{
		AddErtisAuth<ErtisAuthAuthenticationHandler>(services);
	}
	
	// ReSharper disable once MemberCanBePrivate.Global
	public static void AddErtisAuth<TAuthenticationHandler>(this IServiceCollection services) where TAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
	{
