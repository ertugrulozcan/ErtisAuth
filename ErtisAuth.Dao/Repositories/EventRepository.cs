...
public class EventRepository : RepositoryBase<EventDto>, IEventRepository
{
	...
	public EventRepository(IMongoClientProvider clientProvider, IDatabaseSettings settings, IRepositoryActionBinder actionBinder) : base(clientProvider, settings, "events", actionBinder)
	{
